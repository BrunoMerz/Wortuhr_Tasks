...
public:
    ...
    struct MySettings
    {
        ...
        uint8_t colorXXX;                                // Aktuelle Farbe der LEDs
        ...
        char    ssid[34];
        char    passwd[34];
        boolean secondsBell;                          // Sekundenglocke ein/aus
        boolean secondHand;                           // Sekundenzeiger ein/aus
        uint32_t ledcol;                              // LED Color
        uint32_t corcol;                              // Corner Color
        char timezone[35] = {};                       // timezone
        char mqtt_server[30] = {}; 
        char mqtt_user[30] = {}; 
